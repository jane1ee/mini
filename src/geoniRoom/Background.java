...
public class Background extends JFrame{
	...
	public Background(){
		...
		//Room2 이미지 가지고오기 
		icon = new ImageIcon("img/4th/room/Room2.jpg");
		...
		buttonMI = new ImageIcon("img/cursor/check.png").getImage();
		...
		Image finishIm = new ImageIcon("img/4th/finish/finishFrame.jpg").getImage();
		...
		countBt1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Image countIM = new ImageIcon("img/4th/finish/key/" + String.valueOf(count1 = ++count1== 10 ? 0 : count1) + ".png").getImage().getScaledInstance(55,150, 0);
		...
		countBt2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Image countIM = new ImageIcon("img/4th/finish/key/" + String.valueOf(count2 = ++count2== 10 ? 0 : count2) + ".png").getImage().getScaledInstance(55,150, 0);
			...
			public void actionPerformed(ActionEvent e) {
				...
				Image countIM = new ImageIcon("img/4th/finish/key/" + String.valueOf(count3 = ++count3== 10 ? 0 : count3) + ".png").getImage().getScaledInstance(55,150, 0);
			...
			countBt4.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					Image countIM = new ImageIcon("img/4th/finish/key/" + String.valueOf(count4 = ++count4== 10 ? 0 : count4) + ".png").getImage().getScaledInstance(55,150, 0);
			...
			countBt6.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					Image countIM = new ImageIcon("img/4th/finish/key/" + String.valueOf(count6 = ++count6== 10 ? 0 : count6) + ".png").getImage().getScaledInstance(55,150, 0);

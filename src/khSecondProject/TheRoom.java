...
public class TheRoom extends JFrame {
	...
	public TheRoom() {
		...
		Image bgImg = new ImageIcon("img/3rd/room/theroom.jpg").getImage();
...
//		LibraryBGM("bgm/St_Francis.wav");
		...
		switchBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Image runeimg = new ImageIcon("img/3rd/rune/runequiz.jpg").getImage();
		...
		bookcaseBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Image montyhallImg = new ImageIcon("img/3rd/room/dicewall.jpg").getImage();
...
//				montyhallFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				...
				ImageIcon doorIcon = new ImageIcon("img/3rd/button/closeddoor.png");
				Image closedDoorImg = new ImageIcon("img/3rd/button/closeddoor.png").getImage();
				...
				// 1번 문 버튼
				ImageIcon door1Icon = new ImageIcon("img/3rd/button/closeddoor.png");
				...
				door1Btn.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						...
						door2Label.setIcon(new ImageIcon("img/3rd/button/openeddoor.jpg"));		
				...
				// 2번 문 버튼
				ImageIcon door2Icon = new ImageIcon("img/3rd/button/closeddoor.png");
				...
				door2Btn.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						// TODO Auto-generated method stub
						door3Label.setIcon(new ImageIcon("img/3rd/button/openeddoor.jpg"));	
				...
				// 3번 문 버튼
				ImageIcon door3Icon = new ImageIcon("img/3rd/button/closeddoor.png");
				...
				door3Btn.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						// TODO Auto-generated method stub
						door1Label.setIcon(new ImageIcon("img/3rd/button/openeddoor.jpg"));	
...
//				}
		...
		// hint 
		ImageIcon hint = new ImageIcon("img/hint/hint.png");
...
//				hintframe.setUndecorated(true);
				...
				hintimg = new ImageIcon("img/3rd/room/fibonacci_hint.jpg").getImage();
...
//					setVisible(false);
	...
	public void introFrame() {
	      ...
	      Toolkit tk = Toolkit.getDefaultToolkit();
	      img = tk.getImage("img/3rd/room/rendering.gif");
